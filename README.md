...
## あとがき
本プログラムは筆者が駒澤大学経済学部の卒業制作として制作したものです。ここでは研究室配属問題を前提とし学生と研究室の学生提案マッチングを想定していますが、一般のマッチング場面で使用することも可能です。  
作成にあたって、川越敏司『基礎から学ぶマーケット・デザイン』(有斐閣, 2021)を参考にさせていただきました。本著を手に取っていただくとより理解が深まるかと思います。
